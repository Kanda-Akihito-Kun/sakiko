...
const (
	...
	MatrixUDPNATType    MatrixType = "UDP_NAT_TYPE"
...
type UDPNATType string

const (
	UDPNATTypeBlocked        UDPNATType = "Blocked"
	UDPNATTypeOpen           UDPNATType = "Open"
	UDPNATTypeUDPFirewall    UDPNATType = "UDP Firewall"
	UDPNATTypeFullCone       UDPNATType = "Full-cone NAT"
	UDPNATTypeRestrictedCone UDPNATType = "Restricted-cone NAT"
	UDPNATTypeRestrictedPort UDPNATType = "Restricted-port NAT"
	UDPNATTypeSymmetric      UDPNATType = "Symmetric NAT"
	UDPNATTypeUnknown        UDPNATType = "Unknown"
)

type UDPNATInfo struct {
	Type         UDPNATType `json:"type,omitempty"`
...
type Macro interface {
	Type() MacroType
	Run(ctx context.Context, proxy Vendor, task *Task) error
}
