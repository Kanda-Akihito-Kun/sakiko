...
export function SettingsPanel() {
  ...
  const { mode, resolvedMode, exportPictureMode, resolvedExportPictureMode, setMode, setExportPictureMode } = useThemeMode();
      ...
      >
        ...
        >
          <ListItemText
            ...
            secondary={isLoading ? t("settings.language.switching") : t("settings.language.description")}
          />
          <Select
            size="small"
        ...
        >
          <ListItemText
            ...
            secondary={t("settings.themeMode.description")}
          />
        ...
        >
          <ListItemText
            ...
            secondary={t("settings.exportPictureMode.description")}
          />
        ...
        >
          <ListItemText
            primary={(
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                ...
                <Typography variant="body1" fontWeight={600}>
                  {t("settings.appliedTheme.label")}
                </Typography>
              </Box>
            )}
            secondary={
              mode === "system"
                ? t("settings.appliedTheme.systemDescription")
                : t("settings.appliedTheme.fixedDescription")
            }
          />
          <Stack direction="row" spacing={1} alignItems="center">
            <Chip
              size="small"
              color="primary"
              label={resolvedMode === "light" ? t("settings.appliedTheme.lightActive") : t("settings.appliedTheme.darkActive")}
            />
            <Chip
              size="small"
              variant="outlined"
              label={resolvedExportPictureMode === "light" ? t("settings.appliedTheme.exportLight") : t("settings.appliedTheme.exportDark")}
            />
          </Stack>
        </ListItem>
      </List>
