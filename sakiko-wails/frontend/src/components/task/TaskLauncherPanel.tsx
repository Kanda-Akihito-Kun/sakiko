...
import { Box, Button, Chip, IconButton, LinearProgress, List, ListItemButton, ListItemText, Stack, ToggleButton, ToggleButtonGroup, Typography } from "@mui/material";
      ...
      <Stack spacing={2}>
        ...
        <List disablePadding>
          {tasks.map((task) => {
            ...
            const canDeleteTask = task.status === "finished" || task.status === "canceled" || task.status === "failed";
